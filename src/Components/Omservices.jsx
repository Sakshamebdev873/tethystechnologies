    ...
    <>
      ...
      <div className=" w-full pb-8 mt-20">
        <h1 className=" text-2xl lg:text-4xl font-light text-center mt-6 flex justify-center items-center ">
          Mode of<p></p>{" "}
          <h1 className=" text-2xl lg:text-4xl font-medium px-2 "> Transportation </h1>
          <p className="w-8 h-[1px] bg-gray-700"></p>
        </h1>
        <p className="mt-4 lg:mt-7 text-center  " >We offer various modes of transportation depending on the destination, budget, and type of travel experience desired by the client.</p>
      </div>

      <div id="w" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 px-12 ">
      
        <div
          className="box-1 flex flex-col items-center py-5 "
        >
          <a href="https://my.matterport.com/show/?m=GPaMwJqXQaH&mls=1&back=1">
            <img
